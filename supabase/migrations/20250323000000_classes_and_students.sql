-- Classes and students: clients, classes (client-run courses), sessions, students, enrollments.
-- Class = one client's course run (e.g. MOE - Policy Group Level 1).
-- Session = single weekly meeting (10 per class).
